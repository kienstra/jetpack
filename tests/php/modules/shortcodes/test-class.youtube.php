...
class WP_Test_Jetpack_Shortcodes_Youtube extends WP_UnitTestCase {
	 ...
	 * @covers ::jetpack_shortcode_get_youtube_dimensions
	 *
	 * @param array  $query_args The query args to pass to the function.
	 * @param string $expected   The expected return value.
	 */
	public function test_jetpack_shortcode_get_youtube_dimensions( $query_args, $expected ) {
		$GLOBALS['content_width'] = self::CONTENT_WIDTH;
		$this->assertEquals( $expected, jetpack_shortcode_get_youtube_dimensions( $query_args ) );
	}
