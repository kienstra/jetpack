...
function youtube_id( $url ) {
	...
	list( $w, $h ) = jetpack_shortcode_get_youtube_dimensions( $qargs );
...
function jetpack_amp_youtube_shortcode( $atts ) {
	...
	list( $width, $height ) = jetpack_shortcode_get_youtube_dimensions( $query_args );
	return sprintf(
 ...
 */
function jetpack_shortcode_get_youtube_dimensions( $query_args ) {
 ...
 * @return int|bool The video ID based on that URL, or false.
 */
